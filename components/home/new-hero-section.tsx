...
import { ArrowRight, Users, Globe, BookOpen, TrendingUp, Sparkles, AlertCircle, Brain, MapPin, Play, Pause, Volume2, VolumeX, Maximize, X } from 'lucide-react';
...
export function NewHeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-background to-background">
      ...
      {showVideo && (
        <div className="container relative mx-auto px-4 pt-8 z-10">
          <motion.div
